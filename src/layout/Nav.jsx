        ...
        <nav className="border-4 border-double border-blue-500 flex flex-wrap z-50 bg-white p-2.5 text-2xl sticky top-0 flex-col">
            <div className="cursor-pointer max-w-full">
                ...
                <div className=" flex items-center justify-end">
                    ...
                    <button className="rounded bg-red-700 font-normal text-red-950 m-1 p-1.5 cursor-pointer border-none hover:text-shadow-lg text-shadow-black">Login</button>
            ...
            <div className="flex justify-center items-center font-bold flex-wrap max-w-full text-blue-700 cursor-pointer">
                links
            </div>
        </nav>
    )
